...
ui_screen_adapter_apply(ui_watch_digital);
ui_screen_adapter_apply(ui_watch_analog);
ui_screen_adapter_apply(ui_call);
ui_screen_adapter_apply(ui_weather_1);
ui_screen_adapter_apply(ui_weather_2);
ui_screen_adapter_apply(ui_blood_oxy);
ui_screen_adapter_apply(ui_ecg);
ui_screen_adapter_apply(ui_blood_pressure);
ui_screen_adapter_apply(ui_measuing);
