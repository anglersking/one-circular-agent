...
lv_obj_t *ui_weather_2 = NULL;lv_obj_t *ui_bg5 = NULL;lv_obj_t *ui_weather_dots_group1 = NULL;lv_obj_t *ui_dot3 = NULL;lv_obj_t *ui_dot4 = NULL;lv_obj_t *ui_content = NULL;lv_obj_t *ui_city_gruop_2 = NULL;lv_obj_t *ui_todady_weather_content = NULL;lv_obj_t *ui_today_weather_group = NULL;lv_obj_t *ui_today_weather_group1 = NULL;lv_obj_t *ui_today_weather_group2 = NULL;lv_obj_t *ui_today_weather_group3 = NULL;lv_obj_t *ui_today_weather_group4 = NULL;lv_obj_t *ui_today_weather_group5 = NULL;lv_obj_t *ui_today_weather_group6 = NULL;lv_obj_t *ui_today_weather_group7 = NULL;lv_obj_t *ui_today_weather_group8 = NULL;lv_obj_t *ui_days_forecast = NULL;lv_obj_t *ui_week_weather_group = NULL;lv_obj_t *ui_forecast_group = NULL;lv_obj_t *ui_forecast_group1 = NULL;lv_obj_t *ui_forecast_group2 = NULL;lv_obj_t *ui_forecast_group3 = NULL;lv_obj_t *ui_forecast_group4 = NULL;lv_obj_t *ui_forecast_group5 = NULL;lv_obj_t *ui_space = NULL;lv_obj_t *ui_button_down4 = NULL;
// event funtions
...
lv_image_set_src(ui_comp_get_child(ui_today_weather_group, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN), &ui_img_weather_sun_cloud_png);
...
lv_image_set_src(ui_comp_get_child(ui_today_weather_group1, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN), &ui_img_weather_cloud_png);
...
lv_image_set_src(ui_comp_get_child(ui_today_weather_group2, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN), &ui_img_weather_sun_cloud_png);
...
lv_image_set_src(ui_comp_get_child(ui_today_weather_group4, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN), &ui_img_weather_cloud_fog_png);
