...
lv_obj_t *ui_measuing = NULL;lv_obj_t *ui_bg7 = NULL;lv_obj_t *ui_pulse_group3 = NULL;lv_obj_t *ui_measuring = NULL;lv_obj_t *ui_Spinner2 = NULL;lv_obj_t *ui_blood_group = NULL;lv_obj_t *ui_blood1 = NULL;lv_obj_t *ui_blood_fill = NULL;lv_obj_t *ui_blood2 = NULL;lv_obj_t *ui_x_button = NULL;lv_obj_t *ui_x = NULL;
// event funtions
