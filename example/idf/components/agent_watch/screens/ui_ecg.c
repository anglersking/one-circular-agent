...
lv_obj_t *ui_ecg = NULL;lv_obj_t *ui_Image1 = NULL;lv_obj_t *ui_bg1 = NULL;lv_obj_t *ui_title_group_2 = NULL;lv_obj_t *ui_button_down6 = NULL;lv_obj_t *ui_button_round1 = NULL;lv_obj_t *ui_pulse_group1 = NULL;lv_obj_t *ui_health_dots_group1 = NULL;lv_obj_t *ui_dot9 = NULL;lv_obj_t *ui_dot8 = NULL;lv_obj_t *ui_dot10 = NULL;lv_obj_t *ui_chart_group = NULL;lv_obj_t *ui_chart_ecg = NULL;lv_obj_t *ui_chart_ecg_Xaxis = NULL;lv_obj_t *ui_chart_ecg_Yaxis1 = NULL;lv_obj_t *ui_chart_ecg_Yaxis2 = NULL;
// event funtions
...
lv_obj_set_y( ui_chart_ecg_Xaxis, 50 + lv_obj_get_style_pad_bottom(ui_chart_ecg,LV_PART_MAIN) + lv_obj_get_style_border_width(ui_chart_ecg,LV_PART_MAIN) );
...
lv_obj_set_x( ui_chart_ecg_Yaxis1, -50 - lv_obj_get_style_pad_left(ui_chart_ecg,LV_PART_MAIN) - lv_obj_get_style_border_width(ui_chart_ecg,LV_PART_MAIN) + 2 );
...
lv_obj_set_x( ui_chart_ecg_Yaxis2, 25 + lv_obj_get_style_pad_right(ui_chart_ecg,LV_PART_MAIN) + lv_obj_get_style_border_width(ui_chart_ecg,LV_PART_MAIN) + 1 );
...
lv_obj_set_style_outline_pad( ui_chart_ecg, LV_MAX3(50, 50, 25), LV_PART_MAIN | LV_STATE_DEFAULT ); //workaround for ineffective 'overflow visible' flag
