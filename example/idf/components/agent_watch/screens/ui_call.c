...
lv_obj_t *ui_call = NULL;lv_obj_t *ui_bg_3 = NULL;lv_obj_t *ui_avatar = NULL;lv_obj_t *ui_avatar_label = NULL;lv_obj_t *ui_call_time = NULL;lv_obj_t *ui_mute = NULL;lv_obj_t *ui_button_down2 = NULL;lv_obj_t *ui_volume_group = NULL;lv_obj_t *ui_volume_percent = NULL;lv_obj_t *ui_volume_image = NULL;lv_obj_t *ui_volume_arc = NULL;lv_obj_t *ui_button_top2 = NULL;
// event funtions
