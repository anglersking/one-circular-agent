...
lv_obj_t *ui_weather_1 = NULL;lv_obj_t *ui_bg_4 = NULL;lv_obj_t *ui_city_gruop_1 = NULL;lv_obj_t *ui_weather_title_group_3 = NULL;lv_obj_t *ui_label_degree = NULL;lv_obj_t *ui_rain_group = NULL;lv_obj_t *ui_rain_icon = NULL;lv_obj_t *ui_rain_percent = NULL;lv_obj_t *ui_wind_group = NULL;lv_obj_t *ui_wind_icon = NULL;lv_obj_t *ui_wind_speed = NULL;lv_obj_t *ui_weather_dots_group = NULL;lv_obj_t *ui_dot1 = NULL;lv_obj_t *ui_dot2 = NULL;lv_obj_t *ui_weather_image_group = NULL;lv_obj_t *ui_sun = NULL;lv_obj_t *ui_clouds = NULL;lv_obj_t *ui_button_down3 = NULL;
// event funtions
