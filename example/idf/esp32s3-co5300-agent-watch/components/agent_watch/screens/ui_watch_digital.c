...
lv_obj_t *ui_watch_digital = NULL;lv_obj_t *ui_bg_1 = NULL;lv_obj_t *ui_hour_group = NULL;lv_obj_t *ui_label_hour_1 = NULL;lv_obj_t *ui_label_hour_2 = NULL;lv_obj_t *ui_label_min = NULL;lv_obj_t *ui_battery_group = NULL;lv_obj_t *ui_date_group = NULL;lv_obj_t *ui_weather_group_1 = NULL;lv_obj_t *ui_weather_title_group_1 = NULL;lv_obj_t *ui_step_group = NULL;lv_obj_t *ui_daily_mission_group = NULL;lv_obj_t *ui_button_top = NULL;lv_obj_t *ui_button_down = NULL;lv_obj_t *ui_sec_dot = NULL;lv_obj_t *ui_weather_dots_group2 = NULL;lv_obj_t *ui_dot14 = NULL;lv_obj_t *ui_dot15 = NULL;
// event funtions
...
lv_image_set_src(ui_comp_get_child(ui_weather_group_1, UI_COMP_WEATHERGROUP1_CLOUD_FOG_1), &ui_img_weather_sun_cloud_png);
