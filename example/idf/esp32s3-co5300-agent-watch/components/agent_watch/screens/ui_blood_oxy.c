...
lv_obj_t *ui_blood_oxy = NULL;lv_obj_t *ui_bg6 = NULL;lv_obj_t *ui_title_group_1 = NULL;lv_obj_t *ui_button_down5 = NULL;lv_obj_t *ui_button_round = NULL;lv_obj_t *ui_blood_presure_group = NULL;lv_obj_t *ui_blood_oxygen = NULL;lv_obj_t *ui_percent = NULL;lv_obj_t *ui_pulse_group = NULL;lv_obj_t *ui_arc_spo2 = NULL;lv_obj_t *ui_precent_70 = NULL;lv_obj_t *ui_precent_100 = NULL;lv_obj_t *ui_health_dots_group = NULL;lv_obj_t *ui_dot7 = NULL;lv_obj_t *ui_dot6 = NULL;lv_obj_t *ui_dot5 = NULL;lv_obj_t *ui_dots_group1 = NULL;lv_obj_t *ui_dot18 = NULL;lv_obj_t *ui_dot19 = NULL;
// event funtions
